...
export type SyncOnlyMigrator = Omit<Migrator, 'forwardAsync' | 'backwardAsync'>;

export function makeSyncTestMigrator(): Migrator {
...
export function makeSyncOnlyTestMigrator(): SyncOnlyMigrator {
	return makeSyncTestMigrator();
}

export type AsyncOnlyMigrator = Omit<Migrator, 'forward' | 'backward'>;

export function makeAsyncTestMigrator(): Migrator {
	const m = new Migrator();
...
export function makeAsyncOnlyTestMigrator(): AsyncOnlyMigrator {
	return makeAsyncTestMigrator();
}
